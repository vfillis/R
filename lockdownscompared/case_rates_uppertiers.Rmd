...
Merging them by their name brings results for all upper tier local authorities except for "Cornwall and Isles of Scilly" and "Hackney and City of London". -> add new row in csv before to make it work
...
## Group LAs into counties 

There are 31 'upper tier' authorities. 
